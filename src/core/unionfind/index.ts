...
export function qfUnion(uf: UF, p: number, q: number, steps: Step[] = []): Step[] {
  const pid = qfFind(uf, p);
  const qid = qfFind(uf, q);
...
export function quUnion(uf: UF, p: number, q: number, steps: Step[] = []): Step[] {
...
export function pcUnion(uf: UF, p: number, q: number, steps: Step[] = []): Step[] {
